...
'''Bod je definovany ako akykolvek objekt p, pre ktory platia vyrazy
...
class rectangle:
	...
	def __init__(self, p1, p2):
		'''\note Umoznit vytvorit prazdny obdlznik nema zmysel
		napr. z hladiska expand() (ozdlznik by mal iba jeden bod).'''
		self._set(p1, p2)
	...
	def scale(self, k):
		'oba body a, b prenasoby konstantou k'
